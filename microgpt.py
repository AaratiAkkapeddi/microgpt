...
assert args.n_embd    <= 256,   "n_embd too large — keep it at or below 256 or it will be very slow"
assert args.n_layer   <= 8,     "n_layer too large — keep it at or below 8 or it will be very slow"
assert args.num_steps <= 20000, "num_steps too large — keep it at or below 20000 or training will take hours"
assert args.n_embd    >= 8,     "n_embd too small — keep it at or above 8"
assert args.n_layer   >= 1,     "n_layer must be at least 1"
assert args.num_steps >= 1,     "num_steps must be at least 1"
